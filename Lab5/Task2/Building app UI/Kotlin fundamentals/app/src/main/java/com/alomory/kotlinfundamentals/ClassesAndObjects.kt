package com.alomory.kotlinfundamentals
...
class SmartHome(
    ...
    private var numberOfClasses: Int? = 2 // this::class.primaryConstructor?.parameters?.size
...
//    val smartTvDevice = com.alomory.Classes_And_Inheritance.SmartDevice(name = "Android TV", category = "Entertainment", statusCode = 0)
